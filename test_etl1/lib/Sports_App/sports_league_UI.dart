                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 10,),
                                Text('24 February', style: TextStyle(color: Colors.white, fontSize: 16),)
                              ],
                            ),
                          ),
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 10,),
                                Text('18:00 - 20:00', style: TextStyle(color: Colors.white, fontSize: 16),)
                              ],
                            ),
                          ),
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 10,),
                                Text('All levels', style: TextStyle(color: Colors.white, fontSize: 16),)
                              ],
                            ),
                          ),
                        ],
